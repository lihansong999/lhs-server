...
private:
	...
	long long _clientRequestPlayerInfo(const SvcNetMatch & svcNetMatch, const Framework::FWSvcSocketInfo & svcSocketInfo, const Message::MsgPackageRecv * msgPackageRecv);
...
private:
	...
	bool _centerForward(const Message::MsgPackageRecv * msgPackageRecv);
};
