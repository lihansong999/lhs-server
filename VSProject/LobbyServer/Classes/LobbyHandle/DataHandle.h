...
private:
	...
	long long _clientRequestPlayerInfo(DataManipulation * dataManipulation, const SvcNetMatch & svcNetMatch, const Framework::FWSvcSocketInfo & svcSocketInfo, const int mainID, const int assistantID, Framework::FWLogicDataGeneral * logicDataGeneral);
...
private:
	...
	bool _centerForward(DataManipulation * dataManipulation, const int mainID, const int assistantID, Framework::FWLogicDataGeneral * logicDataGeneral);
