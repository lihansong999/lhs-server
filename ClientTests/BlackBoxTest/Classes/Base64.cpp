...
static void _B64Encode(const char * in, int in_len, Message::MSGString & out)
{
	unsigned int bits = 0;
	int char_count = 0;
...
static void _URLB64Push(Message::MSGString & out, char c)
{
	switch (c)
	{
	case '+':
...
static void _URLB64Encode(const char * in, int in_len, Message::MSGString & out)
{
	unsigned int bits = 0;
	int char_count = 0;
	for (int in_index = 0; in_index < in_len; in_index++)
...
static void _URIB64Encode(const char * in, int in_len, Message::MSGString & out)
{
	unsigned int bits = 0;
	int char_count = 0;
	for (int in_index = 0; in_index < in_len; in_index++)
...
Message::MSGString Base64Encode(const Data & data)
{
	return Base64Encode(data.GetPointer(), data.GetSize());
}

Message::MSGString Base64Encode(const char * data, size_t size)
{
	Message::MSGString ret;
	ret.Reserve(_B64EnBound((int)size));
	_B64Encode(data, (int)size, ret);
	return ret;
}

Data Base64Decode(const Message::MSGString & b64)
{
	return Base64Decode(b64.C_Str(), b64.Size());
}

Data Base64Decode(const char * b64)
{
	return Base64Decode(b64, strlen(b64));
}

Data Base64Decode(const char * b64, size_t b64Length)
{
	Data ret;
	int dataSize = 0;
	...
	char * buffer = (char*)malloc(dataBound);
...
Message::MSGString URLBase64Encode(const Data & data)
{
	return URLBase64Encode(data.GetPointer(), data.GetSize());
}

Message::MSGString URLBase64Encode(const char * data, size_t size)
{
	Message::MSGString ret;
...
Data URLBase64Decode(const Message::MSGString & urlb64)
{
	return URLBase64Decode(urlb64.C_Str(), urlb64.Size());
}

Data URLBase64Decode(const char * urlb64)
{
	return URLBase64Decode(urlb64, strlen(urlb64));
}

Data URLBase64Decode(const char * urlb64, size_t urlb64Length)
{
	Data ret;
	int dataSize = 0;
...
Message::MSGString URIBase64Encode(const Data & data)
{
	return URIBase64Encode(data.GetPointer(), data.GetSize());
}

Message::MSGString URIBase64Encode(const char * data, size_t size)
{
	Message::MSGString ret;
...
Data URIBase64Decode(const Message::MSGString & urib64)
{
	return URIBase64Decode(urib64.C_Str(), urib64.Size());
}

Data URIBase64Decode(const char * urib64)
{
	return URIBase64Decode(urib64, strlen(urib64));
}

Data URIBase64Decode(const char * urib64, size_t urib64Length)
{
	Data ret;
	int dataSize = 0;
...
void Base64NoPadding(Message::MSGString * b64)
{
	if (b64->Size() == 0)
		return;
	size_t count = 0;
